...
\begin{titlepage}
	...
	The algorithm has been implemented in C++ to allow for greater optimization.
		...
		As a part of finding chordless cycles in the graph for phase 1 of the kenerlization algorithm, it is recommended in REFKAPLANREF that the maximum cardinality search (MCS) is used.
